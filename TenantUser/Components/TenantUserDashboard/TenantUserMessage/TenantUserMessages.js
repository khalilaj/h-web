...
import TenantUserRequestsDetailsComponent from './TenantUserRequestsDetailsComponent'
...
class TenantUserMessages extends React.Component{
    ...
    if(this.props.message.length == 0) {
     ...
     return(
        <div className='classes.root'>
           <MainTable columnData={columnData} data={this.props.message}>
                {this.props.message.map((n,index) => {
                return (
                  <TableRow hover tabIndex={-1} key={n.id} >
                   ...
                   <TableCell numeric>
                        <TenantUserRequestsDetailsComponent
                           id = {n.id}
 ...
 export default withStyles(styles)(TenantUserMessages)
