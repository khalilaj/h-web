...
class TenantUserRequestsViewComponent extends React.Component {
...
TenantUserRequestsViewComponent = withStyles(styles, {name: 'TenantUserRequestsViewComponent'})(TenantUserRequestsViewComponent);

export default  connect(mapStateToProps, mapDispatchToProps) (TenantUserRequestsViewComponent);
