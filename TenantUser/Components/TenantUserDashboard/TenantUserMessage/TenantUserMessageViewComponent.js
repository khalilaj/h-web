...
class TenantUserMessageViewComponent extends React.Component {
  state = {
    expanded: false,
...
TenantUserMessageViewComponent = withStyles(styles, {name: 'TenantUserMessageViewComponent'})(TenantUserMessageViewComponent);

export default  connect(mapStateToProps, mapDispatchToProps) (TenantUserMessageViewComponent);
